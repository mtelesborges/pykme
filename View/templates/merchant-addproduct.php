...
<div class="container">
	...
	<form action="/merchant/addProduct" method="post" id="addProduct" enctype="multipart/form-data">
        <div class="col m9 s12">
            <h3><?php echo $Core->Translator->translate("Add New Product"); ?></h3>
            <section id="productInfo" class="scrollspy section">
                ...
                foreach($langs as $lang){
                ?>
                <div id="info_<?php echo $lang["code"]?>"  <?php if($lang["code"] == $Core->Translator->lang){?>style="display:block"<?php }?> class="productInfo">
                    <div class="col s12">
                        
                        <input name="defaultInfoLang" class="with-gap" value="<?php echo $lang["id"]?>" <?php if($lang["code"] == $Core->Translator->lang){?>checked="checked"<?php }?> type="radio" id="defaultInfoL_<?php echo $lang["id"]?>"/>
                    ...
                    <div class="input-field col s12">
                        ...
                        <input name="name_<?php echo $lang["id"]?>" data-lang="<?php echo $lang["id"]?>" type="text" class="productName validate"/>
                    </div>
                    <div class="input-field col s12">
                        ...
                        <textarea id="description_<?php echo $lang["id"]?>" data-lang="<?php echo $lang["id"]?>" class="materialize-textarea productDescription validate"></textarea>
                    </div>
                </div>
                <?php
                }
                ...
                <div class="col s12 input-field">
                    ...
                    <select id="productType" class="validate">
                        ...
                        ?>
                        <option value="<?php echo $type["id"]?>"><?php echo $Core->Translator->translate($type["name"]);?></option>
                        <?php
                        }
                        ?>
                    </select>
                ...
                <div id="productPropeties" class="col s12 input-field">
                    <select id="selectProductPropeties" multiple class="validate">
                        <option disabled selected><?php echo $Core->Translator->translate("Please select propeties");?></option>
                        <?php
                        foreach($data["productProperties"] as $property){
                        ?>
                            <option value="<?php echo $property["id"]?>"><?php echo $Core->Translator->translate($property["name"]);?></option>
                        <?php
                        }
                        ?>
                    </select>
                ...
                <div id="ifMedical" class="ishidden">
                    <div class="col s12">
                        <input name="needPrescription" id="needPrescription" type="checkbox"/>
                        <label for="needPrescription"><?php echo $Core->Translator->translate("Check this if doctor prescription is needed for this product.")?></label>
                    </div>
                </div>
                <div id="foodAllergies" style="display:none">
                    <div class="col s12 input-field" id="selectAllergics">
                        ...
                        <select multiple id="allergies">
                            <option disabled selected><?php echo $Core->Translator->translate("Please select allergenics");?></option>
                    ...
                    <div class="col s12">
                        <input type="checkbox" id="noAllergicContent"/>
                        <label for="noAllergicContent"><?php echo $Core->Translator->translate("This product has no allergic content");?></label>
                    </div>
                </div>
            </section>
...
function categoryClicked(catId){
    alert("<?php echo $Core->Translator->translate("Category selected. Please wait a few seconds."); ?>");
