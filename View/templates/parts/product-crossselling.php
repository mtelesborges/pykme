                            ...
                            <div class="collapsible-body">
                                <div style="display:grid">
                                    ...
                                    <p>
                                        ...
                                        <input id="product_<?php echo $product["product_id"];?>_shop_<?php echo $shop["id"];?>_var_0" type="checkbox"  data-shop-id="<?php echo $shop["id"];?>" data-product-id="<?php echo $product["product_id"];?>" data-variation-id="0" name="crossselling[]"/>
                                        <label for="product_<?php echo $product["product_id"];?>_shop_<?php echo $shop["id"];?>_var_0"><span><?php echo $Core->Translator->translate("Default Product")?></span>
                                        </label>
                                    </p>
                                    <?php 
                                    if($hasVariation){
