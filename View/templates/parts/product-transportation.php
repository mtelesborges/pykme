...
<div id="checkTransportation">
    <div class="col m6 s12 input-field">
       <input id="weight" type="number" step="any" class="validate"/>
    ...
    <div class="col s12 m3 input-field">
       <input id="width" type="number" step="any" class="validate"/>
       <label><?php echo $Core->Translator->translate("Width");?></label>
    </div>
    <div class="col s12 m3 input-field">
       <input id="height" type="number" step="any" class="validate"/>
       <label><?php echo $Core->Translator->translate("Height");?></label>
    </div>
    <div class="col s12 m3 input-field">
       <input id="depth" type="number" step="any" class="validate"/>
        ...
        <ul class="collection">
            ...
            <li class="collection-item valign-wrapper">
                <div class="col s1">
                        ...
                        <label for="transportationShop_<?php echo $shop["id"]?>"><span></span>
                        </label>
                </div>
                <div class="col s11">
                    <div class="col s12">
                                   ...
                                   <ul class="collection">
                                        <li class="collection-item" style="background:none;border-color:#fff;">
                                            ...
                                            <div class="col s6 m4">
                                                ...
                                                <label for="transportationVariationShop_<?php echo $shop["id"]?>_0"><span><?php echo $Core->Translator->translate("Delivery + In Store"); ?></span>
                                                </label>
                                            </div>
                                            <div class="col s6 m4">
                                    ...
                                    ?>
                                        <li class="collection-item transportVariation_<?php echo $v["info"]["id"]?>" style="background:none;border-color:#fff;">
                                            ...
                                            <div class="col s12 m4">
                                                ...
                                                <label for="transportationVariationShop_<?php echo $shop["id"]?>_<?php echo $v["info"]["id"]?>"><span><?php echo $Core->Translator->translate("Delivery + In Store"); ?></span>
                                                </label>
                                            </div>
                                            <div class="col s12 m4">
                                                ...
                                                <label for="transportationOnlyVariationShop_<?php echo $shop["id"]?>_<?php echo $v["info"]["id"]?>"><span><?php echo $Core->Translator->translate("Delivery Only"); ?></span>
                                                </label>
                                            </div>
                                        </li>
                                    <?php 
